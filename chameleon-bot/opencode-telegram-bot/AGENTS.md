...
**@chameleon/telegram-bot** is a Telegram bot that acts as a mobile client for the Chameleon resume tailoring system and OpenCode.
It lets a user tailor resumes, scan jobs, score matches, generate cover letters, and run coding tasks on a local machine through Telegram.
