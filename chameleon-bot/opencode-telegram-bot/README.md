# Chameleon Telegram Bot

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Node.js](https://img.shields.io/badge/node-%3E%3D20-brightgreen)](https://nodejs.org)

Chameleon Telegram Bot is a Telegram client for the [Chameleon](https://github.com/HautlyS/chameleon) resume tailoring system and [OpenCode](https://opencode.ai) CLI.

Tailor your resume to any job, scan 17+ job platforms, score matches, generate cover letters, and run AI coding tasks — all from your phone.
