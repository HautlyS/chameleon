...
export const de: I18nDictionary = {
  ...
  "cmd.description.render": "YAML zu PDF rendern",
  "cmd.description.cover_letter": "Anschreiben aus einer Job-URL generieren",
  "cmd.description.question": "Bewerbungsfrage beantworten",
  "cmd.description.score": "CV gegen Job-Analyse bewerten",
  "cmd.description.ghost": "ATS-Geistertext in PDF einfügen",
  "cmd.description.review": "Doppelte KI-Überprüfung eines maßgeschneiderten CV",
  "cmd.description.mode": "Bridge-first / OC-first Routing umschalten",
  "cmd.description.subscribe": "RSS-Jobbenachrichtigungen abonnieren",
  "cmd.description.unsubscribe": "RSS-Jobbenachrichtigungen kündigen",
