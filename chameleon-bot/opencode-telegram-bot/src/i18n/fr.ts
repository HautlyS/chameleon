...
export const fr: I18nDictionary = {
  ...
  "cmd.description.chameleon": "Workflow complet d'adaptation : URL d'emploi → CV personnalisé",
  "cmd.description.scan": "Rechercher des emplois sur toutes les plateformes",
  "cmd.description.analyses": "Voir les analyses d'emploi sauvegardées",
  "cmd.description.cvs": "Voir les CVs personnalisés",
  "cmd.description.render": "Rendre YAML en PDF",
  "cmd.description.cover_letter": "Générer une lettre de motivation depuis une URL d'emploi",
  "cmd.description.question": "Répondre à une question de présélection",
  "cmd.description.score": "Noter un CV par rapport à une analyse d'emploi",
  "cmd.description.ghost": "Injecter du texte ATS fantôme dans un PDF",
  "cmd.description.review": "Double révision IA d'un CV personnalisé",
  "cmd.description.mode": "Basculer le routage bridge-first / OC-first",
  "cmd.description.subscribe": "S'abonner aux alertes RSS d'emploi",
  "cmd.description.unsubscribe": "Se désabonner des alertes RSS d'emploi",
