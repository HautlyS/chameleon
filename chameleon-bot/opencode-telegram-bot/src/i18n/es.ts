...
export const es: I18nDictionary = {
  ...
  "cmd.description.chameleon": "Flujo completo de personalización: URL de empleo → CV adaptado",
  "cmd.description.scan": "Buscar empleos en múltiples plataformas",
  "cmd.description.analyses": "Ver análisis de empleos guardados",
  "cmd.description.cvs": "Ver CVs personalizados",
  "cmd.description.render": "Renderizar YAML a PDF",
  "cmd.description.cover_letter": "Generar carta de presentación desde URL de empleo",
  "cmd.description.question": "Responder una pregunta de selección",
  "cmd.description.score": "Puntuar un CV contra un análisis de empleo",
  "cmd.description.ghost": "Insertar texto ATS oculto en un PDF",
  "cmd.description.review": "Doble revisión con IA de un CV personalizado",
  "cmd.description.mode": "Alternar enrutamiento bridge-first / OC-first",
  "cmd.description.subscribe": "Suscribirse a alertas RSS de empleo",
  "cmd.description.unsubscribe": "Cancelar suscripción a alertas RSS de empleo",
