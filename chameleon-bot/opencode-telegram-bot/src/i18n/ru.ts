...
export const ru: I18nDictionary = {
  ...
  "cmd.description.render": "Преобразовать YAML в PDF",
  "cmd.description.cover_letter": "Создать сопроводительное письмо из URL вакансии",
  "cmd.description.question": "Ответить на вопрос отбора",
  "cmd.description.score": "Оценить резюме по анализу вакансии",
  "cmd.description.ghost": "Вставить скрытый ATS-текст в PDF",
  "cmd.description.review": "Двойная проверка AI адаптированного резюме",
  "cmd.description.mode": "Переключить маршрутизацию bridge-first / OC-first",
  "cmd.description.subscribe": "Подписаться на RSS-уведомления о вакансиях",
  "cmd.description.unsubscribe": "Отписаться от RSS-уведомлений о вакансиях",
