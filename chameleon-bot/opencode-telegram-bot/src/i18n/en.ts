export const en = {
  ...
  "cmd.description.chameleon": "Full tailor workflow: job URL → tailored CV",
  "cmd.description.scan": "Search jobs across platforms",
  "cmd.description.analyses": "List saved job analyses",
  "cmd.description.cvs": "List tailored CVs",
  "cmd.description.render": "Render YAML to PDF",
