...
export const ar: I18nDictionary = {
  ...
  "cmd.description.chameleon": "سير عمل التخصيص الكامل: رابط الوظيفة → سيرة ذاتية مخصصة",
  "cmd.description.scan": "البحث عن وظائف عبر المنصات",
  "cmd.description.analyses": "عرض تحليلات الوظائف المحفوظة",
  "cmd.description.cvs": "عرض السير الذاتية المخصصة",
  "cmd.description.render": "تحويل YAML إلى PDF",
  "cmd.description.cover_letter": "إنشاء خطاب تقديمي من رابط وظيفة",
  "cmd.description.question": "الإجابة على سؤال فرز",
  "cmd.description.score": "تقييم السيرة الذاتية مقابل تحليل الوظيفة",
  "cmd.description.ghost": "حقن نص ATS مخفي في PDF",
  "cmd.description.review": "مراجعة مزدوجة بالذكاء الاصطناعي للسيرة الذاتية المخصصة",
  "cmd.description.mode": "تبديل التوجيه bridge-first / OC-first",
  "cmd.description.subscribe": "الاشتراك في تنبيهات RSS للوظائف",
  "cmd.description.unsubscribe": "إلغاء الاشتراك في تنبيهات RSS للوظائف",
