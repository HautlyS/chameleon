...
export const zh: I18nDictionary = {
  ...
  "cmd.description.render": "将 YAML 渲染为 PDF",
  "cmd.description.cover_letter": "从职位链接生成求职信",
  "cmd.description.question": "回答筛选问题",
  "cmd.description.score": "根据职位分析评分简历",
  "cmd.description.ghost": "向 PDF 注入 ATS 隐藏文本",
  "cmd.description.review": "双 AI 审核定制简历",
  "cmd.description.mode": "切换 bridge-first / OC-first 路由",
  "cmd.description.subscribe": "订阅 RSS 职位提醒",
  "cmd.description.unsubscribe": "取消订阅 RSS 职位提醒",
