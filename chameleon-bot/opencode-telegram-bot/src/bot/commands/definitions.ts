...
const COMMAND_DEFINITIONS: BotCommandI18nDefinition[] = [
  ...
  { command: "chameleon", descriptionKey: "cmd.description.chameleon" },
  { command: "scan", descriptionKey: "cmd.description.scan" },
  { command: "analyses", descriptionKey: "cmd.description.analyses" },
  { command: "cvs", descriptionKey: "cmd.description.cvs" },
  { command: "render", descriptionKey: "cmd.description.render" },
